...
L.Control.WMSLegend = L.Control.extend({
    ...
    _click: function (e) {
        ...
        if (style.display === 'none') {
            ...
            this.iconButton.style.display = this.img.style.display;
